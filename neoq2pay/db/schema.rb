...
ActiveRecord::Schema[8.1].define(version: 2026_04_18_220607) do
  create_table "bank_account_transactions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_bank_account_transactions_on_user_id"
  end
  ...
  add_foreign_key "bank_account_transactions", "users"
